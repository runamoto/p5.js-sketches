//In the next few ones I'm going to iterate on this code to explore what i can do and how it can be changed using elements already in the code
let bubbles = [];
let numBubbles = 100;
let font;
...
function setup() {
  ...
  for (let i = 0; i < points.length; i++) {
    ...
    let color = [0];
    bubbles.push(new BubbleStroke(x, y, targetX, targetY, size, speed, color));
  }
}
